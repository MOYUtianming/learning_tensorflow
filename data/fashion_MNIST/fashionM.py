...
def main(_):
    ...
    train_writer = tf.summary.FileWriter('Fashion-MNIST/logs/fasion/train',
                                         sess.graph)
    ...
    for epoch in range(30):
        ...
        sum_accuracy_train = sess.run(scalar_accuracy,
                                      feed_dict={
                                          x: mnist.train.images,
                                          y_: mnist.train.labels
                                      })

        sum_accuracy_validation = sess.run(scalar_accuracy,
                                           feed_dict={
                                               x: mnist.validation.images,
                                               y_: mnist.validation.labels
                                           })
